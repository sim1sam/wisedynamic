                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                <?php if($transaction->customer_name && $transaction->customer_email): ?>
                                    <strong><?php echo e($transaction->customer_name); ?></strong><br>
                                    <small class="text-muted"><?php echo e($transaction->customer_email); ?></small>
                                <?php elseif($transaction->fund_request_id && $transaction->fundRequest && $transaction->fundRequest->user): ?>
                                ...
                                <?php elseif($transaction->package_order_id && $transaction->packageOrder && $transaction->packageOrder->user): ?>
                                    <strong><?php echo e($transaction->packageOrder->user->name ?? $transaction->packageOrder->full_name); ?></strong><br>
                                    <small class="text-muted"><?php echo e($transaction->packageOrder->user->email ?? $transaction->packageOrder->email); ?></small>
                                <?php elseif($transaction->service_order_id && $transaction->serviceOrder && $transaction->serviceOrder->user): ?>
                                    <strong><?php echo e($transaction->serviceOrder->user->name ?? $transaction->serviceOrder->full_name); ?></strong><br>
                                    <small class="text-muted"><?php echo e($transaction->serviceOrder->user->email ?? $transaction->serviceOrder->email); ?></small>
                                <?php elseif($transaction->isSSLTransaction()): ?>
                                    <strong><?php echo e($transaction->ssl_transaction_id); ?></strong><br>
