        ...
        <div class="relative">
            ...
            <div class="text-center">
                <div class="flex items-center justify-center mb-4">
                    <?php $footerLogo = $footerSettings->footer_logo ?? null; ?>
                    <?php if(!empty($footerLogo)): ?>
                        <img src="<?php echo e(asset($footerLogo)); ?>" alt="<?php echo e($websiteSettings->logo_alt_text ?? 'Company Logo'); ?>" class="h-12 w-auto">
                    <?php elseif(!empty($websiteSettings->site_logo)): ?>
                        <img src="<?php echo e(asset($websiteSettings->site_logo)); ?>" alt="<?php echo e($websiteSettings->logo_alt_text ?? 'Company Logo'); ?>" class="h-12 w-auto">
                    <?php endif; ?>
                </div>
