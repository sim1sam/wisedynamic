                                    ...
                                    <td>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <p class="mb-1"><strong>Paid Amount:</strong> BDT <?php echo e(number_format($order->paid_amount ?? 0)); ?></p>
                                                <p class="mb-1"><strong>Due Amount:</strong> BDT <?php echo e(number_format($order->due_amount ?? $order->amount)); ?></p>
                                                <p class="mb-1">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th colspan="3">BDT <?php echo e(number_format($order->paid_amount ?? 0)); ?></th>
                                            </tr>
                                            <tr>
                                                <th colspan="2" class="text-right">Remaining:</th>
                                                <th colspan="3">BDT <?php echo e(number_format($order->due_amount ?? $order->amount)); ?></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
