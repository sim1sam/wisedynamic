<?php $__env->startSection('title', 'View Service Order'); ?>

<?php $__env->startSection('content_header'); ?>
    <div class="d-flex justify-content-between">
        <h1>Service Order #<?php echo e($order->id); ?></h1>
        <div>
            <a href="<?php echo e(route('admin.service-orders.edit', $order)); ?>" class="btn btn-info mr-2">
                <i class="fas fa-edit"></i> Edit Order
            </a>
            <a href="<?php echo e(route('admin.service-orders.index')); ?>" class="btn btn-secondary">
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <form action="<?php echo e(route('admin.service-orders.update-status', $order)); ?>" method="POST" class="d-flex align-items-center mr-2">
                                                <?php echo csrf_field(); ?>
                                            ...
                                            <form action="<?php echo e(route('admin.service-orders.accept', $order)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                            ...
                                            <form action="<?php echo e(route('admin.service-orders.complete', $order)); ?>" method="POST" class="ml-2">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" class="btn btn-sm btn-success">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="<?php echo e(route('admin.service-orders.process-payment', $order)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Project Name</th>
                                    <td><?php echo e($order->project_name); ?></td>
                                </tr>
                                <?php endif; ?>
                                <?php if($order->project_type): ?>
                                <tr>
                                    <th>Project Type</th>
                                    <td><?php echo e($order->project_type); ?></td>
                                </tr>
                                <?php endif; ?>
                                <?php if($order->requirements): ?>
                                <tr>
                                    <th>Requirements</th>
                                    <td><?php echo e($order->requirements); ?></td>
                                </tr>
                                <?php endif; ?>
                            </table>
                        </div>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\laragon\www\wisedynamic\resources\views/admin/service-orders/show.blade.php ENDPATH**/ ?>