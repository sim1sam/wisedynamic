    ...
    <div class="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 items-stretch">
      ...
      <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-10">
        ...
        <?php if(session('error')): ?>
          <div class="mb-4 p-3 rounded-lg bg-red-50 text-red-700 text-sm"><?php echo e(session('error')); ?></div>
        <?php endif; ?>
        ...
        <form method="post" action="<?php echo e(url('/login')); ?>" class="space-y-5">
          ...
          <div>
            ...
            <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500" required>
          </div>
          <div>
            ...
            <input type="password" name="password" value="" class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500" required>
          </div>
        ...
        <div class="mt-6 text-center text-sm text-gray-600">
          Not an admin? <a href="<?php echo e(route('login')); ?>" class="text-blue-600 hover:underline">User login</a>
        </div>
      </div>
    </div>
  </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\laragon\www\wisedynamic\resources\views/auth/admin-login.blade.php ENDPATH**/ ?>