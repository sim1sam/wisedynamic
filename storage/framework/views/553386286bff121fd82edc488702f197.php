...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if($websiteSetting->site_logo ?? null): ?>
                            <div class="mt-2">
                                <img src="<?php echo e(asset($websiteSetting->site_logo)); ?>" alt="Current Logo" class="img-thumbnail" style="max-height: 100px;">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if($websiteSetting->site_favicon ?? null): ?>
                            <div class="mt-2">
                                <img src="<?php echo e(asset($websiteSetting->site_favicon)); ?>" alt="Current Favicon" class="img-thumbnail" style="max-height: 32px;">
