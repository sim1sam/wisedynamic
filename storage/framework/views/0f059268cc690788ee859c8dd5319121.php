<?php $title = 'Custom Service Request'; ?>
...
<div class="w-full px-4 md:px-6 space-y-6">
    ...
    <div class="bg-white rounded-lg shadow dashboard-card card-blue">
        ...
        <div class="p-6">
            <form action="<?php echo e(route('customer.custom-service.store')); ?>" method="POST" id="customServiceForm">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        ...
                        <div class="border border-gray-300 rounded-lg p-4 cursor-pointer service-type-card" data-type="marketing">
                            <label class="cursor-pointer">
                                <input type="radio" name="service_type" value="marketing" class="sr-only service-type-radio" <?php echo e(old('service_type') === 'marketing' ? 'checked' : ''); ?>>
                                <div class="flex items-center justify-between">
                                    <div>
                        ...
                        <div class="border border-gray-300 rounded-lg p-4 cursor-pointer service-type-card" data-type="web_app">
                            <label class="cursor-pointer">
                                <input type="radio" name="service_type" value="web_app" class="sr-only service-type-radio" <?php echo e(old('service_type') === 'web_app' ? 'checked' : ''); ?>>
                                <div class="flex items-center justify-between">
                                    <div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        ...
                        <div class="border border-gray-300 rounded-lg p-4 cursor-pointer payment-method-card" data-method="balance">
                            <label class="cursor-pointer">
                                <input type="radio" name="payment_method" value="balance" class="sr-only payment-method-radio" <?php echo e(old('payment_method') === 'balance' ? 'checked' : ''); ?>>
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h4 class="font-medium text-gray-900">Account Balance</h4>
                                        <p class="text-sm text-gray-500">Pay using your account balance</p>
                                        <p class="text-xs text-green-600 mt-1">Available: BDT <?php echo e(number_format(auth()->user()->balance, 2)); ?></p>
                                    </div>
                        ...
                        <div class="border border-gray-300 rounded-lg p-4 cursor-pointer payment-method-card" data-method="ssl">
                            <label class="cursor-pointer">
                                <input type="radio" name="payment_method" value="ssl" class="sr-only payment-method-radio" <?php echo e(old('payment_method') === 'ssl' ? 'checked' : ''); ?>>
                                <div class="flex items-center justify-between">
                                    <div>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\laragon\www\wisedynamic\resources\views/frontend/customer/custom-service/create.blade.php ENDPATH**/ ?>