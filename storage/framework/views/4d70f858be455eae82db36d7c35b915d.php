...
<div class="bg-gray-100 py-12">
    <div class="container mx-auto px-4">
        <div class="flex flex-wrap items-center justify-between mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Service Order #<?php echo e($order->id); ?></h1>
            <a href="<?php echo e(route('customer.service-orders.index')); ?>" class="btn-outline-primary px-4 py-2 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    <p class="text-gray-700 font-medium">Service:</p>
                                    <p class="text-gray-900 mb-2"><?php echo e($order->service_name); ?></p>
                                    ...
                                    <?php if(($order->status === 'accepted' || $order->status === 'processing') && ($order->payment_status !== 'paid')): ?>
                                        <div class="mt-4">
                                            <a href="<?php echo e(route('customer.payment.options', ['service', $order->id])); ?>" class="w-full inline-block text-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-semibold">
                                                            ...
                                                            <div class="mt-2 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                                                                ...
                                                                <?php if($order->manualPayment): ?>
                                                                    <div class="mt-2 text-sm text-orange-700">
                                                                        <strong>Submitted:</strong> <?php echo e($order->manualPayment->created_at->format('M d, Y H:i')); ?><br>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <?php if($order->project_name): ?>
                                        <div>
                                            ...
                                            <p class="text-gray-900 mb-2"><?php echo e($order->project_name); ?></p>
                                        </div>
                                    <?php endif; ?>
                                    
                                    <?php if($order->project_type): ?>
                                        <div>
                                            <p class="text-gray-700 font-medium">Project Type:</p>
                                            <p class="text-gray-900 mb-2"><?php echo e($order->project_type); ?></p>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if($order->requirements): ?>
                                        <div class="col-span-2">
                                            ...
                                            <p class="text-gray-900 mb-2"><?php echo e($order->requirements); ?></p>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="relative border-l-2 border-gray-200 ml-3">
                            ...
                            <div class="mb-8 flex items-center">
                                ...
                                <div class="ml-6">
                                    ...
                                    <p class="mt-1 text-sm text-gray-700">Your service order has been placed successfully.</p>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\laragon\www\wisedynamic\resources\views/frontend/customer/service-orders/show.blade.php ENDPATH**/ ?>