...
<section id="contact" class="py-16 bg-white">
    <div class="container mx-auto px-6">
        <div class="text-center mb-12">
            <h2 class="text-4xl font-bold mb-4 gradient-text"><?php echo e($homeSetting->contact_title ?? 'Let\'s Build Something Amazing Together'); ?></h2>
            <div class="w-20 h-1 gradient-bg mx-auto mb-6"></div>
            <p class="text-xl text-gray-600"><?php echo e($homeSetting->contact_subtitle ?? 'Ready to bring your digital vision to life? Contact us today!'); ?></p>
        </div>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600"><?php echo e(($contactSetting->phone ?? null) ?: ($homeSetting->contact_phone ?? '+880 1805 081012')); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600"><?php echo e(($contactSetting->email ?? null) ?: ($homeSetting->contact_email ?? 'sales@wisedynamic.com.bd')); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600"><?php echo e($homeSetting->contact_location ?? 'Bangladesh'); ?></p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white p-8 rounded-lg shadow-2xl">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="text-center space-y-4">
                            <a href="tel:<?php echo e(str_replace(' ', '', ($contactSetting->phone ?? ($homeSetting->contact_phone ?? '+8801805081012')))); ?>" class="inline-block bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-3 rounded-full font-bold text-lg hover:shadow-lg transform hover:scale-105 transition-all duration-300">
                                <i class="fas fa-phone mr-2"></i>Call Now for Free Consultation
                            </a>
                            
                            <?php if($contactSetting->whatsapp ?? null): ?>
                            <div class="mt-3">
                                <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $contactSetting->whatsapp)); ?>?text=Hi%20Wise%20Dynamic,%20I'm%20interested%20in%20your%20services" target="_blank" class="inline-block bg-gradient-to-r from-green-500 to-green-700 text-white px-8 py-3 rounded-full font-bold text-lg hover:shadow-lg transform hover:scale-105 transition-all duration-300">
...
<?php /**PATH F:\laragon\www\wisedynamic\resources\views/frontend/home/sections/contact.blade.php ENDPATH**/ ?>