...
<head>
    ...
    <?php if($websiteSetting && $websiteSetting->site_favicon): ?>
        <link rel="icon" href="<?php echo e(asset('storage/' . $websiteSetting->site_favicon)); ?>" type="image/x-icon">
        <link rel="shortcut icon" href="<?php echo e(asset('storage/' . $websiteSetting->site_favicon)); ?>" type="image/x-icon">
    <?php endif; ?>
