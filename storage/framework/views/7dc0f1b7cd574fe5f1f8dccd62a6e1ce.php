...
<header class="theme-gradient text-white pt-28 pb-16">
    <div class="container mx-auto px-6">
        <div class="max-w-4xl">
            <h1 class="text-4xl md:text-5xl font-extrabold leading-tight"><?php echo e($service->title); ?></h1>
            <p class="mt-4 text-white/90 text-lg"><?php echo e($service->short_description); ?></p>
            <div class="mt-8 flex flex-wrap gap-4">
                <a href="#details" class="btn-primary px-6 py-3 rounded-full font-semibold shadow">Learn More</a>
                <a href="<?php echo e(route('cart.show', ['service' => $service->slug])); ?>" class="bg-white text-gray-900 px-6 py-3 rounded-full font-semibold hover:opacity-90">Apply Now</a>
            </div>
        </div>
    </div>
</header>
        ...
        <div class="lg:grid lg:grid-cols-[1fr,24rem] lg:gap-6">
            ...
            <div class="space-y-8" id="details">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mb-4 lg:mr-3">
                    <?php if($service->image): ?>
                        <img src="<?php echo e(asset('storage/' . $service->image)); ?>" alt="<?php echo e($service->title); ?>" class="w-full h-64 md:h-80 object-cover">
                    <?php else: ?>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-full service-icon flex items-center justify-center">
                            <i class="<?php echo e($service->category->icon ?? 'fas fa-folder'); ?> text-white"></i>
                        </div>
                        <span class="text-gray-700"><?php echo e($service->category->name); ?></span>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="text-gray-700">
                        <?php if($service->price): ?>
                            <div class="text-2xl font-bold mb-2">BDT <?php echo e(number_format($service->price)); ?><?php echo e($service->price_unit ? '/'.$service->price_unit : ''); ?></div>
                        <?php else: ?>
                ...
                <div class="text-center py-10">
                    ...
                    <a href="<?php echo e(url('/#contact')); ?>" class="btn-primary px-6 py-3 rounded-full">Contact Us</a>
                </div>
            </div>
            ...
            <aside class="mt-8 lg:mt-0 lg:sticky lg:top-24 lg:self-start space-y-6">
                ...
                <div class="theme-gradient text-white rounded-xl shadow-lg p-6 min-h-80 flex flex-col justify-between lg:w-full">
                    ...
                    <a href="<?php echo e(route('cart.show', ['service' => $service->slug])); ?>" class="block w-full text-center px-5 py-3 rounded-full mt-2 mb-3 bg-white text-gray-900 font-semibold hover:opacity-90">Apply Now</a>
                    <a href="<?php echo e(route('services.index')); ?>" class="block text-center w-full border border-white/60 rounded-full py-3 text-white hover:bg-white/10">View All Services</a>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="border-b border-gray-100 pb-4 last:border-0 last:pb-0">
                            <h4 class="font-semibold mb-1"><?php echo e($relatedService->title); ?></h4>
                            <p class="text-sm text-gray-600 mb-2"><?php echo e(Str::limit($relatedService->short_description, 80)); ?></p>
                            <a href="<?php echo e(route('services.show', $relatedService->slug)); ?>" class="text-blue-600 text-sm font-medium hover:underline">Learn more →</a>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\laragon\www\wisedynamic\resources\views/frontend/services/show.blade.php ENDPATH**/ ?>