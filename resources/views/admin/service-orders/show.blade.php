...
@section('content_header')
    <div class="d-flex justify-content-between">
        ...
        <div>
            <a href="{{ route('admin.service-orders.edit', $order) }}" class="btn btn-info mr-2">
                <i class="fas fa-edit"></i> Edit Order
            </a>
            <a href="{{ route('admin.service-orders.index') }}" class="btn btn-secondary">
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <form action="{{ route('admin.service-orders.update-status', $order) }}" method="POST" class="d-flex align-items-center mr-2">
                                                @csrf
                                                @method('PATCH')
                                            ...
                                            <form action="{{ route('admin.service-orders.accept', $order) }}" method="POST">
                                                @csrf
                                            ...
                                            <form action="{{ route('admin.service-orders.complete', $order) }}" method="POST" class="ml-2">
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-success">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.service-orders.process-payment', $order) }}" method="POST">
                                            @csrf
