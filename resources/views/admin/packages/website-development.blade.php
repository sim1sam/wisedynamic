...
@section('title', 'Website Development Packages')
                    ...
                    <tbody>
                        @forelse($packages as $package)
                            <tr>
                                ...
                                <td>{{ Str::limit($package->short_description, 50) }}</td>
                                <td>
                                    @if($package->status)
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ url('/packages') }}#web-packages" target="_blank" class="btn btn-sm btn-success">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center">No website development packages found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div id="cardView" class="row" style="display: none;">
                        ...
                        <div class="card h-100 {{ $package->featured ? 'border-primary' : '' }}">
                            ...
                            <div class="card-footer">
                                <div class="btn-group w-100">
                                    ...
                                    <a href="{{ url('/packages') }}#web-packages" target="_blank" class="btn btn-success">
                                        <i class="fas fa-eye"></i> Preview
                                    </a>
                ...
                @empty
                    <div class="col-12 text-center py-5">
                        <p class="text-muted">No website development packages found.</p>
