                    ...
                    <form action="{{ route('admin.pages.update', $page) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('short_description') is-invalid @enderror" id="short_description" name="short_description" rows="3" placeholder="A brief summary of the page content. This will appear in search results and at the top of the page.">{{ old('short_description', $page->short_description) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control textarea-editor @error('content') is-invalid @enderror" id="content" name="content" rows="10">{{ old('content', $page->content) }}</textarea>
                                <small class="form-text text-muted">
