...
<div class="bg-gray-100 py-12">
    <div class="container mx-auto px-4">
        <div class="flex flex-wrap items-center justify-between mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Service Order #{{ $order->id }}</h1>
            <a href="{{ route('customer.service-orders.index') }}" class="btn-outline-primary px-4 py-2 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    ...
                                    <p class="text-gray-900 mb-2">{{ $order->service_name }}</p>
                                    ...
                                    @if($order->status === 'accepted' && ($order->payment_status ?? 'unpaid') !== 'paid')
                                        <div class="mt-4">
                                            <a href="{{ route('customer.payment.options', ['service', $order->id]) }}" class="w-full inline-block text-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-semibold">
                                    ...
                                    @if($order->status === 'processing')
                                        <div class="mt-4">
                                            <form action="{{ route('customer.service-orders.process-payment', $order) }}" method="POST">
                                                @csrf
                                                <div class="mb-3">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    @if($order->project_name)
                                        <div>
                                            ...
                                            <p class="text-gray-900 mb-2">{{ $order->project_name }}</p>
                                        </div>
                                    @endif
                                    ...
                                    @if($order->project_type)
                                        <div>
                                            ...
                                            <p class="text-gray-900 mb-2">{{ $order->project_type }}</p>
                                        </div>
                                    @endif
                                    ...
                                    @if($order->requirements)
                                        <div class="col-span-2">
                                            ...
                                            <p class="text-gray-900 mb-2">{{ $order->requirements }}</p>
                                        </div>
                                    @endif
                                </div>
                            </div>
