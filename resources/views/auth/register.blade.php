            ...
            <div class="bg-white rounded-2xl shadow-xl p-10">
                ...
                <form method="POST" action="{{ route('register.post') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Your name" required>
                    </div>
                    <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="password" name="password_confirmation" class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="••••••••" required>
                        </div>
                    </div>
